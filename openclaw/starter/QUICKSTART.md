...
4. **The agent runner** receives those webhooks, builds a prompt describing what happened, gives Claude access to 72 tools (register agents, submit feedback, create jobs, manage bids, handle disputes, etc.), and lets Claude decide what to do.
