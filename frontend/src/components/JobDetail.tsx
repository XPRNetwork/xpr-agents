        ...
        {job.state >= 4 && job.agent && (
          <section className="rounded-xl border border-line bg-canvas p-5">
            ...
            {deliverableType === 'manifest' && manifest && (
              <div className="space-y-4">
                ...
                {(() => {
                  ...
                  return isPdf
                    ? <iframe src={first.uri} title={first.name} sandbox="allow-scripts" referrerPolicy="no-referrer" className="h-96 w-full rounded-md border border-line bg-white" />
            ...
            {deliverableType === 'application/pdf' && deliverableMediaUrl && (
              <div>
                <iframe src={deliverableMediaUrl} sandbox="allow-scripts" referrerPolicy="no-referrer" className="w-full h-96 rounded border border-line bg-white" />
